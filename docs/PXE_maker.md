...
wget https://github.com/eReuse/device-inventory/releases/download/v7.1.0a2/eReuseOS_v7.1.0a2.iso
...
Add the line:
```
/var/lib/tftpboot/iso/eReuseOS_v7.1.0a2.iso /var/lib/tftpboot/mnt/eReuseOS_iso iso9660 user,ro,loop 0 0
```
